        ...
        <div className="container">
          ...
          <div className="team-grid">
            {[
              ...
              { id: '7', initials: 'YM', name: 'Yassine M Yakhoub', role: 'Education Chair', delay: '0s' },
              ...
              <div key={member.id} className="team-card fade-up" style={member.delay !== '0s' ? { transitionDelay: member.delay } : {}}>
                <div style={{ width: '100%', height: '260px', background: 'var(--color-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--color-gold)', fontFamily: 'var(--font-display)', fontSize: '32px', fontWeight: 900 }}>
                  {member.initials}
                </div>
